...
use _PHPStan_ab84e5579\Nette\NotImplementedException;
use Redis;
...
class MomentoCacheClient implements ICacheClient
{
    ...
    public function geosearch(string $key, array|string $position, float|int|array $shape, string $unit, array $options = []): array
    {
        throw new NotImplementedException();
    }

    public function geosearchstore(string $dst, string $src, array|string $position, float|int|array $shape, string $unit, array $options = []): Redis|array|int|false
    {
        throw new NotImplementedException();
    }
